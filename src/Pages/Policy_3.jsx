        ...
        <div>
            ...
            <div className='w-full h-auto bg-gray-200 flex justify-center pb-20 pt-20'>
                ...
                <div className='ipad:w-full w-2/3 h-auto flex flex-col items-center'>
                    <div className='w-11/12 text-[27px] text-green-800 pb-7 font-bold'>Điều khoản dịch vụ</div>
                    <div className='w-11/12 font-bold pb-4'>1. Giới thiệu</div>
                    ...
                    <div className='w-11/12 font-bold pb-4'>2. Hướng dẫn sử dụng website</div>
                    <div className='w-11/12 pb-2'>
                    ...
                    <div className='w-11/12 font-bold pb-4'>3. Thanh toán an toàn và tiện lợi</div>
                    <div className='w-11/12 pb-2'>
