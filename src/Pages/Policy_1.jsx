        ...
        <div>
            ...
            <div className='w-full h-auto bg-gray-200 flex justify-center pb-20 pt-20'>
                ...
                <div className='ipad:w-full w-2/3 h-auto flex flex-col items-center'>
                    <div className='w-11/12 text-[27px] text-green-800 pb-7 font-bold'>Chính sách đổi trả</div>
                    <div className='w-11/12 font-bold pb-4'>1. Điều kiện đổi trả</div>
                    ...
                    <div className='w-11/12 font-bold pb-4'>2. Quy định về thời gian thông báo và gửi sản phẩm đổi trả</div>
