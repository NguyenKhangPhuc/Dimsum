...
function Contact() {
    return (
        <div>
            <Navbar />
            <div className='w-full h-auto flex pt-20 bg-gray-300 justify-center pb-20'>
                <iframe
                    ...
                    className='w-[500px] h-[600px] border-0'
                >
                </iframe>
                <div className='w-1/2 h-auto bg-yellow-200 flex flex-col items-center'>
