...
function Contact() {
    return (
        <div>
            <Navbar />
            <div className='ipad:max-w-full ipad:gap-5 ipad:flex-col ipad:items-center w-full h-auto flex pt-20 bg-gray-200 justify-center pb-20'>
                <iframe
                ...
                <div className='ipad:w-full w-1/2 h-auto flex flex-col items-center'>
                    <div className='w-11/12 text-[27px] text-green-800 pb-10 font-bold'>Liên hệ</div>
