...
function Product({ title, product }) {
    ...
    const ProductDetail = ({ item }) => {
        return (
            <div className=' w-full h-full bg-opacity-40 fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-black flex items-center justify-center' id>
                <div className='w-2/3 h-1/2 bg-white flex flex-col items-center relative'>
                    ...
                    <div className='w-11/12 h-1/6  mt-10 flex items-center border border-gray-500 gap-4'>
                        <img src={pencil} className='h-full w-[25px] h-[25px] ml-4' />
                        <input type='text' placeholder='Thêm ghi chú' className='w-5/6 h-full focus:outline-none' />
                    </div>
    ...
    return (
        <div className='flex flex-col'>
            <div className='w-full h-[70px] bg-gray-400 text-[20px] flex items-center justify-center border-b border-gray-300'>{title}</div>
