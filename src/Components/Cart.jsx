...
function Cart() {
    // Receive the totalPrice, setTotalPrice, userID, setUserID, cart, setCart 
    // from Container in App.jsx
    ...
    const handleDeleteCartProduct = async (i) => {
        //Parameters:
        // i: the index of the chosen deleted product.

        //Delete the chosen product with Filter method
        //by returning the product that do not have the same index
        //as the chosen product. Calculate the total price.
        //using axios "Post" method to interact with back-end and delete the product
